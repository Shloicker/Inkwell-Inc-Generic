...
def test_pick_up_item():
    ...
    text_adventure.tile_exists(player.location_x, player.location_y).tile_currency_amount = 1000
    player.move_west()
...
def test_drop_item():
    ...
    assert text_adventure.tile_exists(player.location_x, player.location_y).drop_item(player, objects.gold_necklace) ==  "You drop Gold Necklace"
