...
giant_spider_room = combat_room(2, 0, "You find yourself in an opening lit by torches of everlasting fire. The floor and walls are covered in cobwebs... suddenly, a huge and gruesome Giant Spider decends from above and lands in front of you!", "The dead spider lies where it fell.", [game_items.iron_sword, game_items.spider_poison], 100, game_enemies.giant_spider)
merchant_room = shop_room(2, -1, "Miraculously, a daring entrepreneur has set up shop in the dungeon! He asks if you are to be his first customer.", [game_items.steel_sword, game_items.steel_armour, game_items.steel_shield, game_items.healing_potion, game_items.healing_potion], 1000)
