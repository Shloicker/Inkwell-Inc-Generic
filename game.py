...
player = text_adventure.player(inventory=game_player.player_inventory, currency_amount=game_player.player_currency, equipped_weapon=game_player.player_equipped_weapon, equipped_armour=game_player.player_equipped_armour, equipped_shield=game_player.player_equipped_shield)
